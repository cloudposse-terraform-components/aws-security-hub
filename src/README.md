...
| <a name="input_finding_aggregation_region"></a> [finding\_aggregation\_region](#input\_finding\_aggregation\_region) | If finding aggregation is enabled, the region that collects findings | `string` | `"us-east-1"` | no |
